...
{
    public abstract class BaseBookEditRequestHandler<TRequest> : IRequestHandler<TRequest, string>
        where TRequest: Request.BaseBookEditRequest
    {
        ...
        public abstract Task<string> Handle(TRequest request, CancellationToken cancellationToken);
